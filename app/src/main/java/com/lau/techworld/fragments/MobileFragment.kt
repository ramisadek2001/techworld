...
private val dbref = FirebaseDatabase.getInstance().getReferenceFromUrl("https://techworld-69698-default-rtdb.firebaseio.com/products/mobile")
...
//
        ...
        getProductData(this.requireContext())
        return view
    }
