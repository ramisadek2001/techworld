...
private val dbref = FirebaseDatabase.getInstance().getReferenceFromUrl("https://techworld-69698-default-rtdb.firebaseio.com/products/tablets")

/**
 * A simple [Fragment] subclass.
 * Use the [TabletsFragment.newInstance] factory method to
...
class TabletsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(com.lau.techworld.R.layout.fragment_tablets, container, false)



        productRecyclerView = view.findViewById<View>(com.lau.techworld.R.id.recyclertab) as RecyclerView
...
//
    ...
    companion object {
         ...
         * @return A new instance of fragment TabletsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TabletsFragment().apply {
